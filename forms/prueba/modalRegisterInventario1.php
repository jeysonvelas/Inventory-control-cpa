...
<div class="modal fade" id="registroModalInventario1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="insertinventario1.php" onsubmit="return validarForma(this)">
...
<!-- Fin del listar Categorias -->
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="Descripcion" class="form-control form-control-user"
                                        id="exampleInputPassword" placeholder="Ingrese la descripcion del producto" required="true">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="Marca" class="form-control form-control-user"
                                        id="exampleInputPassword" placeholder="Ingrese la Marca y referencia del producto" required="true">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="Stock" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="Ingrese la cantidad del producto" required="true">
                </div>               
            </div>
