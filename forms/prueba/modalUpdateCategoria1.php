<!--ventana para Update--->
<div class="modal fade" id="modificarModalCategoria1<?php echo $row[0]; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="modifyCategory1.php">
