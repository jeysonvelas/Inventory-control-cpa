...
<div class="modal fade" id="modificarModalInventario1<?php echo $row[0]; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<form method="POST" action="modifyInventary1.php">
