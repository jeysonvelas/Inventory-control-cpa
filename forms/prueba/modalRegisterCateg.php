...
<div class="modal fade" id="registerModalCategoria" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" action="insertcategoria.php" onsubmit="return validarForma(this)">
