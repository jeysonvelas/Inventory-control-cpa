                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Lista de todos las Categorias:</h6>
                        </div>
                        <div class="card-body">
                                            ...
                                            while ($row = mysqli_fetch_row($result)){ ?> 
                                               ...
                                               <?php if ($_SESSION['Perfil']=='1'){?>
						                        ...
						                        <tr>
                                                    ...
                                                    <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modificarModalCategoria<?php echo $row[0]; ?>"><i class="fas fa-user-edit"> Edit</i></button></td>
                                                    <td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModalCategoria<?php echo $row[0]; ?>"><i class="fas fa-trash-alt"> Delete</i></button></td>
                                                </tr>
                                                
                                                <!-- Ventana modal Update -->
                                                <?php include('modalUpdateCategoria.php'); ?>

                                                <!-- Ventana modal Delete -->
                                                <?php include('modalDeleteCategoria.php'); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row[1]; ?></td>
                                                    <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modificarModalCategoria<?php echo $row[0]; ?>"><i class="fas fa-user-edit"> Edit</i></button></td>
                                                    <td><button type="button" class="btn btn-secondary" ><i class="fas fa-trash-alt"> Delete</i></button></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td><?php echo $row[0]; ?></td>
                                                    <td><?php echo $row[1]; ?></td>
                                                    <td><button type="button" class="btn btn-secondary" ><i class="fas fa-user-edit"> Edit</i></button></td>
                                                    <td><button type="button" class="btn btn-secondary" ><i class="fas fa-trash-alt"> Delete</i></button></td>                                                
                                                </tr>
