            ...
            <li class="nav-item">
                ...
                '<div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#"><i class="fas fa-search"></i>&nbsp;&nbsp;Consulta de Reportes</a>
                    </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Consulta de Reportes</h1>
                    <p class="mb-4">Aqui encontrara las novedades realizadas [Eliminacion/Modificacion]. Sobre el inventario</p>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tfoot>
                                    ...
                                    <?php
                                            include('conex.php');
                                            $consulta = "SELECT id_reporte, CONCAT(A.Nombre, ' ', A.Apellido), id_inventario, Producto, Categoria, Descripcion, Marca, Stock, Evento, Fecha 
                                            FROM reporte R
                                            INNER JOIN tbl_usuarios A ON R.id_usuario = A.id_usuario";
