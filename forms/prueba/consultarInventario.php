                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Lista de todo el inventario:</h6>
                        </div>
                        <div class="card-body">
...
<div class='progress-bar bg-success' role='progressbar' style='width: 100%' aria-valuenow='25' aria-valuemin='0' aria-valuemax='50'></div>
                                                    ...
                                                    <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modificarModalInventario<?php echo $row[0]; ?>"><i class="fas fa-user-edit"> Edit</i></button></td>
                                                    <td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModalInventario<?php echo $row[0]; ?>"><i class="fas fa-trash-alt"> Delete</i></button></td>
                                                </tr>
                                                
                                                <!-- Ventana modal Update -->
                                                <?php include('modalUpdateInventario.php'); ?>

                                                <!-- Ventana modal Delete -->
                                                <?php include('modalDeleteInventario.php'); ?>
