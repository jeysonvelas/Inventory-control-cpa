                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Lista de todos los Productos:</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <?php
                                            ...
                                            while ($row = mysqli_fetch_row($result)){ ?>                                              
                                               ...
                                               <tr>
                                                    ...
                                                    <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modificarModalProducto<?php echo $row[0]; ?>"><i class="fas fa-user-edit"> Edit</i></button></td>
                                                    <td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModalProducto<?php echo $row[0]; ?>"><i class="fas fa-trash-alt"> Delete</i></button></td>
                                                </tr>
                                                
                                                <!-- Ventana modal Update -->
                                                <?php include('modalUpdateProducto.php'); ?>

                                                <!-- Ventana modal Delete -->
                                                <?php include('modalDeleteProducto.php'); ?>
